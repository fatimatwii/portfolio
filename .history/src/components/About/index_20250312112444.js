    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          and more.  </p>
          <p>
          I believe in the power of technology to transform education and businesses, and I’m always eager to take on new challenges, whether it's optimizing IT systems or crafting innovative web solutions.  </p>
        </div>
