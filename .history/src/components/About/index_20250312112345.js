    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
          With hands-on experience in modern web technologies, I enjoy developing custom websites and 
          platforms for businesses, schools, and professionals—including doctors, nutritionists, and more.   </p>
          <p>
