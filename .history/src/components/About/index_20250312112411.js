      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            infrastructure.
          <p align="LEFT">
          Alongside my managerial role, I specialize in the MERN stack, having honed my skills through an intensive Full Stack Bootcamp. I leverage my expertise to build dynamic, user-friendly web applications that solve real-world problems.   </p>
         </p>
          <p>
